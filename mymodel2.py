...
class Net(nn.Module):
    def __init__(self, upscale_factor):
        ...
        self.convdw2=nn.Conv2d(64,64,3,1,1,groups=64,bias=False)
        self.convpw2=nn.Conv2d(64,64,1,1,0,bias=False)

        self.convdw3=nn.Conv2d(64,64,3,1,1,groups=64,bias=False)
        self.convpw3=nn.Conv2d(64,32,1,1,0,bias=False)
