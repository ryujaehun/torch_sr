...
class Net(nn.Module):
    def __init__(self, upscale_factor):
        ...
        self.convdw5=nn.Conv2d(16,16,(5,1),1,(2,0),groups=16,bias=False)
        self.convpw5=nn.Conv2d(16,16,(1,1),1,0,bias=False)

        self.convdw6=nn.Conv2d(16,16,(3,3),1,1,groups=16,bias=False)
        self.convpw6=nn.Conv2d(16,upscale_factor**2,(1,1),1,0,bias=False)
