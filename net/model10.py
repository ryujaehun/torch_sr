...
class Net(nn.Module):
    def __init__(self, upscale_factor):
        ...
        self.convdw3=nn.Conv2d(16,16,(3,1),1,(1,0),groups=16,bias=False)
        self.convpw3=nn.Conv2d(16,16,(1,1),1,0,bias=False)

        self.convdw4=nn.Conv2d(16,16,(3,1),1,(1,0),groups=16,bias=False)
        self.convpw4=nn.Conv2d(16,16,(1,1),1,0,bias=False)
