...
class Net(nn.Module):
    def __init__(self, upscale_factor):
        ...
        self.convdw2=nn.Conv2d(32,32,(5,5),(1,1),(2,2),groups=32,bias=True)
        self.convpw2=nn.Conv2d(32,16,1,1,0,bias=True)
        self.convdw3=nn.Conv2d(16,16,(5,5),(1,1),(2,2),groups=16,bias=True)
    ...
    def _initialize_weights(self):
        ...
        init.orthogonal(self.convdw2.weight)
        init.orthogonal(self.convpw2.weight, init.calculate_gain('relu'))
        init.orthogonal(self.convdw3.weight)
