...
class Net(nn.Module):
    def __init__(self, upscale_factor):
        ...
        self.convpw2=nn.Conv2d(8,32,(1,1),1,(0,0),bias=False)

        self.convdw3=nn.Conv2d(32,32,(3,1),1,(1,0),groups=32,bias=False)
        self.convpw3=nn.Conv2d(32,32,(1,1),1,0,bias=False)

        self.convdw4=nn.Conv2d(32,32,(3,1),1,(1,0),groups=32,bias=False)
        self.convpw4=nn.Conv2d(32,8,(1,1),1,0,bias=False)
