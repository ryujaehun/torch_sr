...
class Net(nn.Module):
    def __init__(self, upscale_factor):
        ...
        self.convdw2=nn.Conv2d(64,64,(5,1),(1,1),(2,0),groups=64,bias=True)
        ...
        self.convdw4=nn.Conv2d(16,16,(5,1),(1,1),(2,0),groups=16,bias=True)
        self.convpw4=nn.Conv2d(16,8,1,1,0,bias=True)
    ...
    def _initialize_weights(self):
        ...
        init.orthogonal(self.convpw4.weight, init.calculate_gain('relu'))
