...
class Net(nn.Module):
    def __init__(self, upscale_factor):
        ...
        self.relu = nn.ReLU()
        self.conv1 = nn.Conv2d(1, 16, (3, 3), (1, 1), (1, 1),bias=True)
        self.convdw2=nn.Conv2d(16,16,(5,1),1,(2,0),groups=16,bias=True)
        self.convpw2=nn.Conv2d(16,32,(1,1),1,(0,0),bias=True)

        self.convdw3=nn.Conv2d(32,32,(5,1),1,(2,0),groups=32,bias=True)
        self.convpw3=nn.Conv2d(32,32,(1,1),1,0,bias=True)

        self.convdw4=nn.Conv2d(32,32,(5,1),1,(2,0),groups=32,bias=True)
        self.convpw4=nn.Conv2d(32,16,(1,1),1,0,bias=True)

        self.convdw5=nn.Conv2d(16,16,(3,3),1,1,groups=16,bias=True)
        self.convpw5=nn.Conv2d(16,upscale_factor**2,(1,1),1,0,bias=True)
