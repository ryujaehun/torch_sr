...
# this feature depth doublei
class Net(nn.Module):
    def __init__(self, upscale_factor):
        super(Net, self).__init__()

        self.relu = nn.ReLU()
        self.conv1 = nn.Conv2d(1, 32, (3, 3), (1, 1), (1, 1),bias=False)
        self.convdw2=nn.Conv2d(32,32,(5,1),1,(2,0),groups=32,bias=False)
        self.convpw2=nn.Conv2d(32,64,(1,1),1,(0,0),bias=False)

        self.convdw3=nn.Conv2d(64,64,(5,1),1,(2,0),groups=64,bias=False)
        self.convpw3=nn.Conv2d(64,64,(1,1),1,0,bias=False)

        self.convdw4=nn.Conv2d(64,64,(5,1),1,(2,0),groups=64,bias=False)
        self.convpw4=nn.Conv2d(64,32,(1,1),1,0,bias=False)

        self.convdw5=nn.Conv2d(32,32,(3,3),1,1,groups=32,bias=False)
        self.convpw5=nn.Conv2d(32,upscale_factor**2,(1,1),1,0,bias=False)
